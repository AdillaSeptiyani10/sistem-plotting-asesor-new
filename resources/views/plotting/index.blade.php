            ...
            <div class="card stretch stretch-full">
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover" id="plottingList">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Asesor</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="hstack gap-3">
                                            ...
                                            <div>
                                                <span class="d-block fw-bold">{{ $item->asesor->nama }}</span>
                                                <span class="fs-12 text-muted">{{ $item->asesor->bidang }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="hstack gap-3">
                                            ...
                                            <div>
                                                <span class="d-block fw-bold">{{ $item->peserta->nama }}</span>
                                                <span class="fs-12 text-muted">{{ $item->peserta->jurusan }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <i class="feather-map-pin me-2"></i>{{ $item->lokasi }}
                                    </td>
                                    <td>
